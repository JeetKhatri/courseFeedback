						...
						<table id="example1"
							...
							<tbody>
								...
								<tr>
									...
									%>
									<td align="center"><img src="photos/no1.jpg"
										height="30" width="30" class="img-rounded" /></td>
									<%
										} else {
									%>
									<td align="center"><img src="photos/yes1.jpg"
										height="30" width="30" class="img-rounded" /></td>
									<%
										}
									%>
									...
									<td><center>
											...
											<a
												...
												<img src="photos/Recycle Bin.ico" height="30"
												width="30" class="img-rounded" />
											</a>
										</center></td>
									<%} %>
								</tr>
